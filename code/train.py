...
def main(args):
    ...
    def make_dataset(is_train, cached=None):
        ...
        if 'vos' in args.data_path.lower() or 'kinetics' in args.data_path.lower():
            return Kinetics400(
    ...
    if args.load_cache!="":
        ...
        if not os.path.exists(cache_path):
            raise FileNotFoundError("You specified a bad cache path to load from: " + str(cache_path))
        #print("!!!")
        #cache_path = "drive/Shareddrives/EECS 542/vos_all_clips"
        ...
        if args.save_cache!="" and ('kinetics' in args.data_path.lower() or 'vos' in args.data_path.lower()):
            cache_path = args.save_cache
            if not os.path.exists(cache_path):
                raise FileNotFoundError("You specified a bad cache path to save to: " + str(cache_path))
